...
import { verificaEmailExisteBanco } from "../helpers/authparticipante.js";

//me perdoe o eventos me lascou todinho, eu tenteii ajeita
//corrigido no dia 3 para nao ficar dando erro
...
//fiz a logica da inscrição do participante no evento, ta funcional isso que vale S2
export const registerEventosParticipantes = (req, res) => {
